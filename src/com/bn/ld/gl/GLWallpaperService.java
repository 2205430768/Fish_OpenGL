...
import com.bn.ld.UtilTools.IntersectantUtil;
import com.bn.ld.UtilTools.MatrixUtil;
import com.bn.ld.Vecrors.Vector3f;
import com.bn.ld.gl.BaseConfigChooser.ComponentSizeChooser;
import com.bn.ld.gl.BaseConfigChooser.SimpleEGLConfigChooser;
...
public class GLWallpaperService extends WallpaperService {
	...
	public class GLEngine extends Engine {
		...
		public final static int RENDERMODE_CONTINUOUSLY = 1;//主动渲染模式
		...
		*/
		...
		public void setRenderer(Renderer renderer) {
			...
			mGLThread.start();
			//---------添加的---------
			this.renderer=(TDRender) renderer;
		}
		...
		private TDRender renderer;//场景渲染器
		@Override
				...
				if (Constant.feeding) {
					...
					if (Constant.isFeed) {
						...
						Vector3f[] AB = IntersectantUtil.calculateABPosition(
								...
								Constant.farABS);
								// Fposition(世界坐标系)
								Vector3f Start = AB[0];// 起点
								Vector3f End = AB[1];// 终点
								// 判断不位空启动
